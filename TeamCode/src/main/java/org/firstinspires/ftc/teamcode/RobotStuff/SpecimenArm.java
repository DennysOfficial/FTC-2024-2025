...
public class SpecimenArm {
    ...
    public static SpecimenArmPose restPose = new SpecimenArmPose(.73, 0, -60);
    public static double resetPresetDurationSec = 1;
    public static SpecimenArmPose scorePose = new SpecimenArmPose(.73, 17, 32);
    public static double scorePresetDurationSec = 1;
    public static SpecimenArmPose collectPose = new SpecimenArmPose(0.3, 1, -52);
