...
public class Pincher {
    ...
    void updatePincher() {
        if (config.playerTwo.pinchBumper.getState() && (config.playerTwo.pinchBumper.getState() != previousPinchButton))
            togglePincher();
        previousPinchButton = config.playerTwo.pinchBumper.getState();
