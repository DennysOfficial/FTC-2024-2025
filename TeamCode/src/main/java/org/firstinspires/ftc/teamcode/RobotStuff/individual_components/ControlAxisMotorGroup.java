...
public abstract class ControlAxisMotorGroup {  //schrödinger's code
    ...
    protected abstract void initMotors(OpMode opmode, RobotConfig config);
    ...
    public ControlAxisMotorGroup(ControlMode defaultControlMode, OpMode opMode, RobotConfig config, String axisName, String unitName, double unitsPerEncoderCount) {
        this.opMode = opMode;
        this.config = config;
