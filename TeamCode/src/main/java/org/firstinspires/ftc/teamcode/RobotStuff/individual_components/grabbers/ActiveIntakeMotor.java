...
public class ActiveIntakeMotor {
    ...
    public void setWristServoPosition(float wristServoPosition) {
        this.wristServoPosition = wristServoPosition;
    }

    public void stow() {
        wristServoPosition = 0; //Change this to resting position
    }

    public void activate() {
        wristServoPosition = 0; //Change this to collecting position
    }
