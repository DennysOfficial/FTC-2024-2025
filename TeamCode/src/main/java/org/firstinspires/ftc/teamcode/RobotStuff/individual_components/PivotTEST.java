...
@Config
public class PivotTEST extends ControlAxisTEST { //schrödinger's code

    LiftTEST lift;

    public void assignLift(LiftTEST lift) {
        if (lift == null)
    ...
    public PivotTEST(ControlMode defaultControlMode, OpMode opMode, RobotConfig config) {
