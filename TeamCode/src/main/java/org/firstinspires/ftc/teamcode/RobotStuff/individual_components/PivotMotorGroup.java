...
@Config
public class PivotMotorGroup extends ControlAxisMotorGroup { //schrödinger's code

    protected DcMotorEx rightPivot;
    protected DcMotorEx leftPivot;

    protected MotorGroup pivotMotors;
    ...
    @Override
    protected void initMotors(OpMode opmode, RobotConfig config) {
        leftPivot = opmode.hardwareMap.get(DcMotorEx.class, config.deviceConfig.leftPivot);
        rightPivot = opmode.hardwareMap.get(DcMotorEx.class, config.deviceConfig.rightPivot);

        MotorEx leftPivotMotor = new MotorEx(leftPivot);
        MotorEx rightPivotMotor = new MotorEx(rightPivot);
        ...
        MotorGroup pivotMotors = new MotorGroup(leftPivotMotor, rightPivotMotor);
    }


    public PivotMotorGroup(ControlMode defaultControlMode, OpMode opMode, RobotConfig config) {
